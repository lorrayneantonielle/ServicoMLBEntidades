...
using ServicoMLBEntidades.Infrastructure.Queries;
...
builder.Services.AddScoped<IEtapaObraRepository, EtapaObraRepository>();
...
builder.Services.AddScoped<IMutiraoEscalaRepository, MutiraoEscalaRepository>();
builder.Services.AddScoped<IPresencaRepository, PresencaRepository>();
builder.Services.AddScoped<IPontuacaoQueryService, PontuacaoQueryService>();
...
builder.Services.AddScoped<EtapaObraService>();
...
builder.Services.AddScoped<MutiraoService>();
